<template>
  <div class="container">
    <!-- 树莓派选择器 -->
    <div class="raspi-selector">
      <el-select
        v-model="selectedRaspi"
        placeholder="请选择树莓派设备"
        size="large"
        :loading="loadingRaspi"
        class="raspi-select"
        @change="handleRaspiChange"
      >
        <el-option
    ...
    <div class="main-content">
      ...
      <div class="left-section">
        ...
        <div class="thumbnails">
          ...
          >
            <el-image
              :src="`http://39.98.221.201:8989${camera.imagePath}`"
              fit="cover"
...
// 处理树莓派选择变化
const handleRaspiChange = (value: number) => {
  // 重置当前选中的摄像头索引
...
.main-content {
  display: flex;
  height: calc(100vh - 145px); /* 调整高度，考虑树莓派选择器 */
  gap: 20px;
  flex: 1;
}
